...
class ConditionalPeriodFromToStringTest extends TestCase
{
    ...
    {
        $cpString = 'C1-2P1Y';
        $cp = new ConditionalPeriod(ConditionalType::CATEGORY, 1, 2, new DateInterval('P1Y'));
    ...
    public function testDurationFromToString()
    {
        ...
        $cp = new ConditionalPeriod(ConditionalType::DURATION, new DateInterval('P1Y'), new DateInterval('P1Y2M3D'), new DateInterval('P1Y2M3DT1H2M3S'));
